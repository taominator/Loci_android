...
Item {
    ...
    Rectangle {
        ...
        Rectangle {
            id: leftRect_buttton
            color: leftRect_buttton_field.containsMouse? "#51979F" : "#94B7C5"
            ...
            MouseArea {
                id: leftRect_buttton_field
                anchors.fill: parent
                cursorShape: Qt.PointingHandCursor
                hoverEnabled: true

                onClicked: {
                    leftRect_visibility = true
                    rightRect_visibility = false
                }
            }
        }

        Rectangle {
            id: rightRect_buttton
            color: rightRect_buttton_field.containsMouse? "#51979F" : "#6F9AAB"
            width: parent.width / 2
            anchors{
                left: leftRect_buttton.right
                top: parent.top
                bottom: parent.bottom
            }
            ...
            MouseArea {
                id: rightRect_buttton_field
                anchors.fill: parent
                cursorShape: Qt.PointingHandCursor
                hoverEnabled: true

                onClicked: {
                    rightRect_visibility = true
                    leftRect_visibility = false
                }
            }
        }
    }
    ...
    property bool leftRect_visibility: true
    property bool rightRect_visibility: false
